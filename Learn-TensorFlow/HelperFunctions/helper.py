...
def make_confusion_matrix(y_true, y_pred, classes=None, figsize=(10, 10),
    ...
    cax = ax.matshow(cm, cmap=plt.cm.viridis)
    fig.colorbar(cax)
...
def results(y_true, y_pred, classification=True):
    """
    ...
    :param classification: True indicates model is a classification type else regression, default True
